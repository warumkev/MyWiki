...
<body>
  ...
  <div class="container">
    ...
    <div class="card rounded mx-auto d-block img-thumbnail w-25 p-3" style="width: 18rem;">
      <img src="./img/<?php echo $row['cover']; ?>" class="card-img-top" style="height: 18rem; object-fit: cover;"
        alt="./img/<?php echo $row['cover']; ?>">
      <div class="card-body">
        <p class="card-text">Veröffentlicht von <a href="home.php?authorid=<?php echo $row['author']; ?>">
